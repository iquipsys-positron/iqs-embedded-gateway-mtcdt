...
var StatisticsReqMessage = require("../../src/protocol/StatisticsReqMessage");

suite('StatisticsReqMessage', function () {

    test('Reading and writing message', function () {
        var writeStream = new WriteStream();

        var message = new StatisticsReqMessage();
        message.org_id = '1';
        message.gw_udi = '2';
        ...
        var message2 = new StatisticsReqMessage();
